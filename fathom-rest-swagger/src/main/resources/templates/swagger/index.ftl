...
<head>
    ...
    <script src="${webjarsAt('swagger-ui/lib/object-assign-pollyfill.js')}"></script>
    ...
    <script src="${webjarsAt('swagger-ui/lib/handlebars-4.0.5.js')}"></script>
    <script src="${webjarsAt('swagger-ui/lib/lodash.min.js')}"></script>
    <script src="${webjarsAt('swagger-ui/lib/backbone-min.js')}"></script>
    <script src="${webjarsAt('swagger-ui/swagger-ui.js')}"></script>
    <script src="${webjarsAt('swagger-ui/lib/highlight.9.1.0.pack.js')}"></script>
    <script src="${webjarsAt('swagger-ui/lib/highlight.9.1.0.pack_extended.js')}"></script>
