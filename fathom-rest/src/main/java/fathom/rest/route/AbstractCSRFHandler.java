 ...
 * @author James Moger
 */
public abstract class AbstractCSRFHandler implements RouteHandler<Context> {

    public static final String TOKEN = "csrfToken";

    private static final Logger log = LoggerFactory.getLogger(AbstractCSRFHandler.class);
    ...
    public AbstractCSRFHandler() {
        this(CryptoUtil.generateSecretKey());
    }

    public AbstractCSRFHandler(String secretKey) {
        this(secretKey, CryptoUtil.HMAC_SHA256);
    }

    public AbstractCSRFHandler(String secretKey, String algorithm) {
    ...
    protected abstract String getSessionCsrfToken(Context context);

    protected abstract void setSessionCsrfToken(Context context, String token);

    protected abstract String getTokenId(Context context);
