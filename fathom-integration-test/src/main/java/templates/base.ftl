...
<head>
    ...
    <link rel="stylesheet" href="${webjarsAt("foundation/5.5.1/css/foundation.min.css")}">
    <link rel="stylesheet" href="${webjarsAt("font-awesome/4.3.0/css/font-awesome.min.css")}">
    <link rel="stylesheet" href="${webjarsAt("datatables/1.10.4/css/jquery.dataTables.min.css")}">
...
<div class="row">
    <nav class="top-bar" data-topbar role="navigation">
        <ul class="title-area">
            <li class="name">
                <h1><a href="${contextPath}/"><i class="fa fa-anchor"></i> ${appName}</a></h1>
            </li>
        </ul>
                ...
                <#if account??>
                    <li class="has-dropdown">
                        ...
                        <ul class="dropdown">
                            ...
                            <li><a href="${contextPath}/logout"><i class="fa fa-sign-out"></i> ${i18n('fathom.logout')}
                            </a></li>
                        </ul>
                    </li>
                <#else>
                    <li class="has-form">
                        <a class="button" href="${contextPath}/login"><i
...
<script src="${webjarsAt("foundation/5.5.1/js/foundation.min.js")}"></script>
<script src="${webjarsAt("foundation/5.5.1/js/foundation/foundation.alert.js")}"></script>
<script src="${webjarsAt("datatables/1.10.4/js/jquery.dataTables.min.js")}"></script>
